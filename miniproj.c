...
void displayScene2()
{
    ...
    glBegin(GL_QUADS);
    glVertex3f(-0.30*n, 0.825*1.8*n, 0);
    glTexCoord2f(0, 0);
    glVertex3f(1.280*1.8*n, 0.825*1.8*n, 0);
    glTexCoord2f(0, 1);
    glVertex3f(1.280*1.8*n,-0.5*n ,0);
    glTexCoord2f(1, 1);
    glVertex3f(-0.30*n, -0.5*n, 0);
    glTexCoord2f(1, 0);
    glEnd();
    glFlush();
 ...
 void loadBackground(void)
{
    ...
    unsigned char *data = stbi_load("glass1.jpg", &width, &height, &nrChannels, STBI_rgb_alpha);
...
void myInit()
{
    ...
    glClearColor(0.8196, 0.8627, 0.87060, 0.0);
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
